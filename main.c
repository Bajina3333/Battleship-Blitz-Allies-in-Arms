...
void DrawGame(void)
{
    ...
    if(gamebegining)
    {
        ...
        DrawText("WECOEM TO", screenWidth/2 - MeasureText("WECOEM TO", 40)/2, 200, 40, RED);
        DrawText("Battleship-Blitz-Allies-in-Arms", screenWidth/2 - MeasureText("Battleship-Blitz-Allies-in-Arms", 40)/2, 300, 40, RED);
